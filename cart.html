...
<head>
    ...
    <!-- ==== Document Title ==== -->
    <title>QuickFix - Multipurpose Servicing and Repairing HTML Template</title>
    ...
    <div class="wrapper">
            ...
            <div class="header--navbar-top">
                <div class="container">
                    ...
                    <div class="logo float--left">
                        <div class="vc--parent">
                            <div class="vc--child">
                                <a href="index.html"><img src="img/logo.png" alt="Quick Fix Logo" data-rjs="2"></a>
                            </div>
                        </div>
                    </div>
                    <!-- Logo End -->
                    ...
                    <div class="float--right">
                        ...
                        <div class="header--navbar-top-btn float--left">
                            <div class="vc--parent">
                                <div class="vc--child">
                                    <a href="index.html#appointment" class="btn btn-default">Make An Appoinment</a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="page-header--section text-center">
            ...
            <div class="page--breadcrumb font--secondary">
                <div class="container">
                    <ul class="breadcrumb">
                        <li><a href="index.html">Quick Fix</a></li>
                        <li><a href="shop.html">Shop</a></li>
        ...
        <div class="cart--section pd--100-0">
            <div class="container">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td data-label="Catalogue">
                                        <a href="shop-details.html">
                                            <img src="img/cart-img/cart-item-01.jpg" alt="" data-rjs="2">
                                        </a>
                                    </td>

                                    <td data-label="Product Name">
                                        <a href="shop-details.html">Summer Product Red</a>
                                    </td>

                                    <td data-label="Price">$08.99</td>

                                    <td data-label="Quantity">
                                        <div class="quantity">
                                            <input type="text" value="2" data-trigger="spinner" data-min="1" data-max="10">
                                        </div>
                                    </td>

                                    <td data-label="Total Price">$08.99</td>

                                    <td data-label="Remove"><a href="#" class="remove"><i class="fa fa-close"></i></a></td>
                                </tr>
                                <tr>
                                    <td data-label="Catalogue">
                                        <a href="shop-details.html">
                                            <img src="img/cart-img/cart-item-02.jpg" alt="" data-rjs="2">
                                        </a>
                                    </td>

                                    <td data-label="Product Name">
                                        <a href="shop-details.html">Canon 70D Camera</a>
                                    </td>
                                    ...
                                    <td data-label="Quantity">
                                        <div class="quantity">
                                            <input type="text" value="1" data-trigger="spinner" data-min="1" data-max="10">
                                        </div>
                                    </td>

                                    <td data-label="Total Price">$180.00</td>
                                ...
                                <tr>
                                    <td data-label="Catalogue">
                                        <a href="shop-details.html">
                                            <img src="img/cart-img/cart-item-03.jpg" alt="" data-rjs="2">
                                        </a>
                                    </td>

                                    <td data-label="Product Name">
                                        <a href="shop-details.html">Drop &amp; Drug Your Tagline</a>
                                    </td>

                                    <td data-label="Price">$19.98</td>
                                    ...
                                    <td data-label="Total Price">$19.98</td>
                ...
                <div class="row">
                    <!-- Cart Coupon Start -->
                    <div class="cart--coupon col-md-4 col-sm-6">
                        <h2 class="cart--title h4">Coupon Code</h2>

                        <p class="sub-title">Enter your coupon code if you have one</p>
                            ...
                            <form action="#">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-btn">
                                        <button type="submit" class="btn btn-default active">Apply Coupon</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <!-- Cart Total Start -->
                    <div class="cart--total col-md-4 col-md-offset-4 col-sm-6">
                        <h2 class="cart--title h4">Cart Totals</h2>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="cta--btn">
                            <a href="index.html#banner" class="btn btn-default">Get Free Estimate</a>
                        </div>
                        <!-- Call To Action Button Start -->
                    </div>
                </div>
                ...
                <div class="row reset--gutter">
                    <div class="col-md-3 bg--color-theme bg--overlay">
                        ...
                        <div class="footer--about">
                            ...
                            <div class="info">
                                <ul class="nav">
                                    <li class="fa-home">House #896, East Sheprapara Beside  of Hazi Asraf Ali School, Dhaka, Bangladesh.</li>

                                    <li class="fa-envelope"><a href="mailto:you@yourmail.com">you@yourmail.com</a>, <a href="mailto:you@yourmail.com">you@yourmail.com</a></li>

                                    <li class="fa-phone-square"><a href="mailto:+055997766554412">+055997766554412</a>, <a href="mailto:005594765243">005594765243</a></li>
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="footer--widgets row">
                            ...
                            <div class="footer--widget col-md-4">
                                ...
                                <div class="links--widget">
                                    <ul class="nav">
                                        <li><a href="#"><i class="fa fa-angle-double-right"></i>PC and Mac Repair</a></li>
                                        <li><a href="#"><i class="fa fa-angle-double-right"></i>iPad and Smartphone Repair</a></li>
                                        <li><a href="#"><i class="fa fa-angle-double-right"></i>Camera and Lens Repair</a></li>
                                        <li><a href="#"><i class="fa fa-angle-double-right"></i>Printer and Scanner Repair</a></li>
                                        <li><a href="#"><i class="fa fa-angle-double-right"></i>Television and LCD/LED Display Repair</a></li>
                                        <li><a href="#"><i class="fa fa-angle-double-right"></i>Electronics Accessories Sales and Repair</a></li>
                                    </ul>
                                </div>
                                <!-- Links Wdiget End -->
                            </div>
                            ...
                            <div class="footer--widget col-md-4">
                                ...
                                <div class="recent-posts--widget">
                                    <ul class="nav">
                                        <li class="clearfix">
                                            <div class="img">
                                                <a href="blog-details.html"><img src="img/blog-img/recent-post-01.jpg" alt="" data-rjs="2"></a>
                                            </div>

                                            <div class="content">
                                                <h3 class="h6"><a href="blog-details.html">The Summer Sppecial Day Out</a></h3>
                                                <p>Jan 19 2017</p>
                                            </div>
                                        </li>
                                        <li class="clearfix">
                                            <div class="img">
                                                <a href="blog-details.html"><img src="img/blog-img/recent-post-02.jpg" alt="" data-rjs="2"></a>
                                            </div>

                                            <div class="content">
                                                <h3 class="h6"><a href="blog-details.html">The Post Writen By Saju</a></h3>
                                                <p>Jan 19 2017</p>
                                            </div>
                                        </li>
                                        <li class="clearfix">
                                            <div class="img">
                                                <a href="blog-details.html"><img src="img/blog-img/recent-post-03.jpg" alt="" data-rjs="2"></a>
                                            </div>

                                            <div class="content">
                                                <h3 class="h6"><a href="blog-details.html">Drop &amp; Drug Your Tagline Here</a></h3>
                                                <p>Jan 19 2017</p>
                                            </div>
                                        </li>
                                    </ul>
                        ...
                        <div class="footer--copyright font--secondary clearfix">
                            ...
                            <p class="float--right"><a href="#">Quick Fix</a> by Themelooks</p>
                        </div>
